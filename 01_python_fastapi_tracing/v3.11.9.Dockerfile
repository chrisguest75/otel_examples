...
CMD ["opentelemetry-instrument", "--traces_exporter", "console", "--metrics_exporter", "console", "--logs_exporter", "console", "--service_name", "01_python_fastapi_tracing", "--log_level", "TRACE", "uvicorn", "main:app", "--host", "0.0.0.0"]
